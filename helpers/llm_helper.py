...
#     """
#
#     if provider == GlobalConfig.PROVIDER_QWEN:
#         from openai import OpenAI
#         import httpx
#         # 配置代理信息
#         proxy_config = {
#             "http://": "http://10.80.242.6:80",  # HTTP代理
#             "https://": "http://10.80.242.6:443"  # HTTPS代理
#         }
#
#
#         logger.debug('Getting LLM via QWEN endpoint: %s', model)
#         print(api_key)
#         # 创建带代理的客户端
#         client = OpenAI(
#             api_key=api_key,
