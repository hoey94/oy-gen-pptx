...
#
# from helpers.custom_embeddings import CustomAPIEmbeddings
#
#
# sys.path.append('..')
# sys.path.append('../..')
...
# # cache_dir = parent_dir + "/cache/huggingface"
# # print(cache_dir)
# # tokenizer = BertTokenizer.from_pretrained(GlobalConfig.TINY_BERT_MODEL, cache_dir=cache_dir)
# # model = BertModel.from_pretrained(GlobalConfig.TINY_BERT_MODEL, cache_dir=cache_dir)
#
#
...
#     outputs = []
#
#     for i, chunk in enumerate(chunk_list(texts, 128)):
#         print(f"📦 第 {i + 1} 批，共 {len(chunk)} 条")
#
#         output = CustomAPIEmbeddings().get_embedding_batch(chunk)
...
#     """
#
#     print("load_saved_embeddings ing ")
